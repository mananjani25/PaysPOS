                ...
                if (modelName != -1) {
                    ...
                    if (!containsFlag && mPrinter != null) {
                        ...
                        try {
                            ...
                            if (makeErrorMessage(status!!)?.isNotEmpty() == true) {
                                runOnUiThread {
                                    ToastUtil.showNormalToast(this, makeErrorMessage(status) ?: "")
                                }
                                ...
                                mPrinter?.requestPrintJobStatus("Done")
