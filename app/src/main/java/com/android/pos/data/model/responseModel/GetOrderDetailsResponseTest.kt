...
@Parcelize
data class GetOrderDetailsTest(
    @SerializedName("data")
    val `data`: Data,
    ...
    data class Data(
        ...
        data class Customer(
            ...
            data class Addresse(
                ...
                val street: String,
                @SerializedName("type_o 2021-09-15 17:00:26.358 17432-20576/com.android.pos I/okhttp.OkHttpClient: f_address")
                val typeO202109151700263581743220576comAndroidPosIokhttpOkHttpClientFAddress: String
            ) : Parcelable
