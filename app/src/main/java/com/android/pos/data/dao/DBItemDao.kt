...
interface DBItemDao {
    ...
    */
    ...
    @Query("select * from TbItem where TbItem.categoryId  = :id and TbItem.name != 'Manual Item' and TbItem.isDeleted = 0 and TbItem.hide_status = 'UnHide'")
    ...
    @Query("SELECT * from TbItem where TbItem.id  = :id and TbItem.name != 'Manual Item' and TbItem.isDeleted = 0 LIMIT 1")
    fun itemByIdMod(id: Int?):TbItem?
