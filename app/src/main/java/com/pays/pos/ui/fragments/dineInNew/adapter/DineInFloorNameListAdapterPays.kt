...
import com.pays.pos.ui.fragments.dineInNew.DineInViewModelPays
import com.pays.pos.ui.fragments.dinein.DineInViewModel

class DineInFloorNameListAdapterPays(val viewModel: DineInViewModelPays) :
    RecyclerView.Adapter<DineInFloorNameListAdapterPays.MyViewHolder>() {
    ...
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): DineInFloorNameListAdapterPays.MyViewHolder {
    ...
    override fun onBindViewHolder(holder: DineInFloorNameListAdapterPays.MyViewHolder, position: Int) {
