...
import com.pays.pos.data.model.requestModel.CreateModifierRequestModel
import com.pays.pos.data.model.requestModel.ModifierSet
import com.pays.pos.data.model.responseModel.CreateModifierSetResponse
...
class CreateModifierViewModel @Inject constructor(
    ...
    private fun updateModifierDataInItem(modifierSet: com.pays.pos.data.entities.ModifierSet) {
        CoroutineScope(Dispatchers.IO).launch {
            try {
                var tempModifierSetIds: ArrayList<Int> = arrayListOf()
                val oldModifierSet: com.pays.pos.data.entities.ModifierSet? =
