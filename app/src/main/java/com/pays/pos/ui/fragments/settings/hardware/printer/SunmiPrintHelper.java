...
public class SunmiPrintHelper {
    ...
    public void printText(String s){
        ...
        try {
            sunmiPrinterService.printText(s, null);
        } catch (RemoteException e) {
            e.printStackTrace();
        }
    }

    public void printText(String s, Float font){

        try {
            sunmiPrinterService.printTextWithFont(s, null,font,null);
        } catch (RemoteException e) {
            e.printStackTrace();
        }
    }
    ...
    public void printExample(Context context) {
        ...
        try {
            ...
            sunmiPrinterService.printText("Nidhi cafe's\n", null);
            ...
            sunmiPrinterService.printTextWithFont("ABCDEFGHIJKLMNOPQRSTUVWXYZABCDEFGHIJKLMNOPQRSTUVWXYZ\n",
                    null, 12, null);
            if (paper == 1) {
                sunmiPrinterService.printText("--------------------------------\n", null);
            } else {
            ...
            String txts[] = new String[]{"Hello", "Words"};
            ...
            sunmiPrinterService.printTextWithFont("Take Out", null, 40, null);
            sunmiPrinterService.setAlignment(1, null);
            sunmiPrinterService.printQRCode("123456", 10, 0, null);
            sunmiPrinterService.setFontSize(36, null);
            sunmiPrinterService.printText("Good Logic", null);
            sunmiPrinterService.autoOutPaper(null);
        } catch (RemoteException e) {
            e.printStackTrace();
        }
