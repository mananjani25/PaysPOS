...
class KitchenPrinterListAdapter : RecyclerView.Adapter<KitchenPrinterListAdapter.MyViewHolder>() {
    ...
    inner class MyViewHolder(private val binding: ViewPrinterItemBinding) :
        ...
        fun bind(model: PrinterListModel?) {
            ...
            if (model != null) {
                binding.swtOrderId.isChecked = model.isKitchenActive
            }
...
//                Log.d("deDupedNodes","Unique operaion id = ${it.id} , name = ${it.printerName}")
    ...
    interface PrinterListInterface {
        ...
        fun onUpdateKitchenPrinterStatus(printerListModel: PrinterListModel, isChecked: Boolean, type: String)
