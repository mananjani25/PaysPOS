...
//        performGetOperationNew(networkCall = { apiHelperNew.syncVenueData() })
    ...
    fun fetchCustomerPrintersList() = appDatabase.printerDao().getCustomerPrintList
...
//        appDatabase.optionSetDao().delete()
    ...
    suspend fun updateCashEventsByOrderId(cashEventId: Int, cashLogRequest:CashLogRequest)=apiHelperNew.updateCashEventsByOrderId(cashEventId,cashLogRequest)
