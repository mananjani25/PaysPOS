...
public abstract class AppDatabase : RoomDatabase() {
    ...
    companion object {
        ...
        private val MIGRATION_18_19: Migration = object : Migration(18, 19) {
            override fun migrate(database: SupportSQLiteDatabase) {
                try {
                    database.execSQL("ALTER TABLE TbTips ADD COLUMN isCheckedInAdapter INTEGER DEFAULT 0 NOT NULL")
        ...
        private val MIGRATION_19_20: Migration = object : Migration(19, 20) {
            override fun migrate(database: SupportSQLiteDatabase) {
                try {
                    database.execSQL("ALTER TABLE TbDynamicPaymentRecords ADD COLUMN deleted_at TEXT DEFAULT NULL")
        ...
        private val MIGRATION_20_21: Migration = object : Migration(20, 21) {
            override fun migrate(database: SupportSQLiteDatabase) {
                try {
                    database.execSQL("ALTER TABLE TbDiscount ADD COLUMN sort INTEGER DEFAULT 0")
        ...
        private val MIGRATION_21_22: Migration = object : Migration(21, 22) {
            override fun migrate(database: SupportSQLiteDatabase) {
                try {
                    database.execSQL("ALTER TABLE TbCartItem ADD COLUMN actualPrice DOUBLE DEFAULT 0.0 NOT NULL")
        ...
        val MIGRATION_25_26: Migration = object : Migration(25, 26) {
            override fun migrate(database: SupportSQLiteDatabase) {
                try {
                    database.execSQL("ALTER TABLE TBCartItem ADD COLUMN isOldDineInItem INTEGER DEFAULT 0 NOT NULL")
                } catch (e: Exception) {
                    e.printStackTrace()
                }
            }
