...
import com.pays.pos.data.model.responseModel.category.CategoriesResponse
import com.pays.pos.data.model.responseModel.category.CreateCategoryResponse
...
import com.pays.pos.data.model.responseModel.item.ItemsResponse
import com.pays.pos.data.model.responseModel.orderhistory.OrderHistoryResponse
import com.pays.pos.data.model.responseModel.report.ReportSummaryResponse
import com.pays.pos.data.remote.Constants.ACCEPTED_DECLINE_ONLINEORDER
import com.pays.pos.data.remote.Constants.ALL_ORDERS
import com.pays.pos.data.remote.Constants.ALL_ORDER_COUNTS
import com.pays.pos.data.remote.Constants.BUSINESS_UPDATE
import com.pays.pos.data.remote.Constants.CASH_EVENTS
...
import com.pays.pos.data.remote.Constants.DELETE_QUEUE_PRINTER
import com.pays.pos.data.remote.Constants.DELETE_UPDATE_PRINTER
import com.pays.pos.data.remote.Constants.DESTROY_QUEUE
import com.pays.pos.data.remote.Constants.DISCOUNTS
import com.pays.pos.data.remote.Constants.DISCOUNTS_ACTIVE
import com.pays.pos.data.remote.Constants.DISCOUNTS_UPDATE_DELETE
import com.pays.pos.data.remote.Constants.EMAIL_REPORT_SUMMARY
import com.pays.pos.data.remote.Constants.EMPLOYEES
import com.pays.pos.data.remote.Constants.EMPLOYEES_TIMESHEET
import com.pays.pos.data.remote.Constants.EMPLOYEES_TIMESHEET_DETAILS
import com.pays.pos.data.remote.Constants.EMPLOYEES_UPDATE_DELETE
import com.pays.pos.data.remote.Constants.EMPLOYEE_CLOCK_IN
import com.pays.pos.data.remote.Constants.EMPLOYEE_LOG_IN
...
import com.pays.pos.data.remote.Constants.GIFT_CARDS
import com.pays.pos.data.remote.Constants.GIFT_CARD_ADD_BALANCE
import com.pays.pos.data.remote.Constants.GIFT_CARD_CHECK_BALANCE
import com.pays.pos.data.remote.Constants.GIFT_CARD_EMAIL_RECEIPT
import com.pays.pos.data.remote.Constants.GIFT_CARD_PHONE_RECEIPT
import com.pays.pos.data.remote.Constants.HIDE_CATEGORY
import com.pays.pos.data.remote.Constants.HIDE_ITEM
import com.pays.pos.data.remote.Constants.INCREASE_ONGOING_ORDER_COUNTER
import com.pays.pos.data.remote.Constants.INVENTORY_COUNTS
import com.pays.pos.data.remote.Constants.ITEMS
import com.pays.pos.data.remote.Constants.ITEM_UPDATE_DELETE
import com.pays.pos.data.remote.Constants.KITCHEN_RECEIPT_SETTINGS
import com.pays.pos.data.remote.Constants.KITCHEN_RECEIPT_UPDATE_SEETINGS
import com.pays.pos.data.remote.Constants.LOGIN_TERMINAL
import com.pays.pos.data.remote.Constants.LOGOUT
import com.pays.pos.data.remote.Constants.LOYALTY_POINT
import com.pays.pos.data.remote.Constants.LOYALTY_POINT_ACTIVE
import com.pays.pos.data.remote.Constants.LOYALTY_POINT_UPDATE_DELETE
import com.pays.pos.data.remote.Constants.MERGE_FLOOR_TABLE
import com.pays.pos.data.remote.Constants.MODIFIER
import com.pays.pos.data.remote.Constants.MODIFIER_UPDATE_DELETE
import com.pays.pos.data.remote.Constants.NOTES
import com.pays.pos.data.remote.Constants.NOTES_ACTIVE
import com.pays.pos.data.remote.Constants.NOTE_UPDATE_DELETE
import com.pays.pos.data.remote.Constants.ONLINE_ORDERING
import com.pays.pos.data.remote.Constants.ONLINE_ORDER_COUNTS
import com.pays.pos.data.remote.Constants.ONLINE_ORDER_NOTIFICATION_COUNT
import com.pays.pos.data.remote.Constants.OPEN_ORDERS
import com.pays.pos.data.remote.Constants.OPTION_SETS
import com.pays.pos.data.remote.Constants.OPTION_UPDATE_DELETE
import com.pays.pos.data.remote.Constants.ORDERS
import com.pays.pos.data.remote.Constants.ORDER_ASSIGN_CUSTOMER
import com.pays.pos.data.remote.Constants.ORDER_COUNTS
import com.pays.pos.data.remote.Constants.ORDER_DETAILS
import com.pays.pos.data.remote.Constants.ORDER_EMAIL_RECEIPT
import com.pays.pos.data.remote.Constants.ORDER_HISTORY
import com.pays.pos.data.remote.Constants.ORDER_PAY_AMOUNT_WISE
import com.pays.pos.data.remote.Constants.ORDER_PHONE_RECEIPT
import com.pays.pos.data.remote.Constants.ORDER_TYPES
import com.pays.pos.data.remote.Constants.PAYMENT_DETAILS
import com.pays.pos.data.remote.Constants.PAY_BY_GUEST
import com.pays.pos.data.remote.Constants.PHONE_ORDERS
import com.pays.pos.data.remote.Constants.PHONE_ORDER_COUNTS
import com.pays.pos.data.remote.Constants.REFUND_PAYMENT
import com.pays.pos.data.remote.Constants.REORDER_CATEGORY
import com.pays.pos.data.remote.Constants.REORDER_ITEM
import com.pays.pos.data.remote.Constants.REORDER_MODIFIER
import com.pays.pos.data.remote.Constants.REORDER_NOTE
import com.pays.pos.data.remote.Constants.REORDER_OPTION_SET
import com.pays.pos.data.remote.Constants.REORDER_TIP
import com.pays.pos.data.remote.Constants.REPORT_EMPLOYEE_TIP_SUMMARY
import com.pays.pos.data.remote.Constants.REPORT_EOD_SUMMARY
import com.pays.pos.data.remote.Constants.REPORT_SUMMARY
import com.pays.pos.data.remote.Constants.SERVICE_CHARGE
import com.pays.pos.data.remote.Constants.SERVICE_CHARGE_ACTIVE
import com.pays.pos.data.remote.Constants.SERVICE_CHARGE_UPDATE_DELETE
import com.pays.pos.data.remote.Constants.SERVICE_CHARGE_WHOLE
import com.pays.pos.data.remote.Constants.START_DATE
import com.pays.pos.data.remote.Constants.SYNC_VENUE_DATA
import com.pays.pos.data.remote.Constants.SYNC_VENUE_DETAILS
import com.pays.pos.data.remote.Constants.TAXES
import com.pays.pos.data.remote.Constants.TAX_ACTIVE
import com.pays.pos.data.remote.Constants.TAX_UPDATE_DELETE
import com.pays.pos.data.remote.Constants.TEAM_ROLES
import com.pays.pos.data.remote.Constants.TEAM_ROLES_UPDATE_DELETE
import com.pays.pos.data.remote.Constants.TEXT_TO_PAY_SPIT
import com.pays.pos.data.remote.Constants.TIME_DETAILS
import com.pays.pos.data.remote.Constants.TIPS
import com.pays.pos.data.remote.Constants.TIPS_ACTIVE
import com.pays.pos.data.remote.Constants.TIPS_UPDATE_DELETE
...
import com.pays.pos.data.remote.Constants.UPDATE_SERVICECHARGE
import com.pays.pos.data.remote.Constants.UPDATE_TIP
import com.pays.pos.data.remote.Constants.UPDATE_TIP_WITH_SIGNATURE
import com.pays.pos.data.remote.Constants.USERS_LOG_IN
import com.pays.pos.data.remote.Constants.WASTAGE_ITEM
