package com.pays.pos.data.model.requestModel.giftCard.request
...
data class GiftCardAddValueRequest(
    ...
    data class GiftCardAmountTab(
        ...
        data class PaymentAttributes(
            ...
            val service_charge_amount: Double? = 0.0,
            ...
            val total_cash_discount: Double? = 0.0,
