...
import com.pays.pos.data.remote.Constants.CREATE_QUEUE_PRINTER_PHASE3
import com.pays.pos.data.remote.Constants.DELETE_QUEUE_ORDER_PHASE3
import com.pays.pos.data.remote.Constants.DINE_IN
import com.pays.pos.data.remote.Constants.DINE_IN_SPACE
...
import com.pays.pos.data.remote.Constants.PRINTER_QUEUE_CONNECTION_URL_SNACKPOS
...
import com.pays.pos.utils.addHorizontalLineNewU220
import com.pays.pos.utils.addOrdersForKitchenCustomer
import com.pays.pos.utils.addOrdersForKitchenCustomerNewPrinter
import com.pays.pos.utils.padLine
import com.pays.pos.utils.printGuestByItemForQueue
                ...
                if (printerObjList.size != dataList.size()) {
                    ...
                    if (listOfPrintersData.get(0).printerName.contains("CloudPrint_", true)) {
                        ...
                        if (orderSize != 0) {
                            ...
                            sendDataToPrintToSunmi(
                                listOfPrintersDataIN = listOfPrintersData,
                                currentPrinterIndex,
...
*/
    ...
    private fun sendDataToPrintToSunmi(
        listOfPrintersDataIN: ArrayList<PrinterJSONElementData>,
...
*/
    ...
    private fun sendDataToCloudPrint(
        ...
        if (obj.orderType.equals(DINE_IN, true) || obj.orderType.equals(DINE_IN_SPACE, true)) {
        ...
        if (obj.orderType != DINE_IN && obj.orderType != DINE_IN_SPACE && obj.customerName != null && obj.customerName.isNotEmpty()) {
            cloudPrinter?.let { addDoubleDotLineForSunmiQueue(it) }
            cloudPrinter?.lineFeed(1)
 ...
 */
            ...
            if (printerBreak) {
                ...
                if (obj.orderType.equals(DINE_IN, true) || obj.orderType.equals(
                        DINE_IN_SPACE,
                        true
                    )
                ) {
...
//                p0?.endTransaction()
  ...
  */
            ...
            if (listOfPrintersData.isNotEmpty() && listOfPrintersData.get(currentPrinterIndex).printerQueueModelList.isNotEmpty()) {
                if (listOfPrintersData.get(currentPrinterIndex).printerQueueModelList.size - 1 == currentOrderIndex) {
