...
import static com.pays.pos.utils.CustomSwipeLayout.Utils.getViewWeight;
import static com.pays.pos.utils.CustomSwipeLayout.Utils.setTint;
...
public class SwipeLayout extends FrameLayout implements View.OnTouchListener, View.OnClickListener {
    ...
    private void setUpAttrs(AttributeSet attrs) {
        ...
        itemWidth = array.getDimensionPixelSize(R.styleable.SwipeLayout_swipeItemWidth, 150);
        iconSize = array.getDimensionPixelSize(R.styleable.SwipeLayout_iconSize, ViewGroup.LayoutParams.WRAP_CONTENT);
        textSize = array.getDimensionPixelSize(R.styleable.SwipeLayout_textSize, NO_ID);
        textTopMargin = array.getDimensionPixelSize(R.styleable.SwipeLayout_textTopMargin, 0);
